...
def can_be_found_updated_and_saved
  ...
  # movie = Movie.create(title: "Awesome Flick") ??? the test already does this...
  movie = Movie.find_by(title:"Awesome Flick") # why do i need to add this line?
  movie = Movie.update(movie.id, :title => "Even Awesomer Flick")
  movie.save
end
