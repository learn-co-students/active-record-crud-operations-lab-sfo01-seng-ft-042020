...
def can_find_by_multiple_attributes(arg = {title: "Title", release_date: 2000, director: "Me"})
  # Search Values:
  # title == "Title"
  # release_date == 2000
  # director == "Me"
...
def can_be_found_updated_and_saved
  ...
  movie_new = Movie.find(1)
  movie_new.title =  "Even Awesomer Flick"
  movie_new.save
end
